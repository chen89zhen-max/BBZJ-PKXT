...
let state: AppState = {
  ...
  subjects: [
    ...
    { id: 's-14', name: '汽车文化', type: '专业课', departmentId: 'dept-1', majorId: 'major-1' },
    { id: 's-15', name: '汽车美容', type: '专业课', departmentId: 'dept-1', majorId: 'major-1' },
    { id: 's-16', name: '汽车机械基础', type: '专业课', departmentId: 'dept-1', majorId: 'major-2' },
    { id: 's-17', name: '汽车机械制图与CAD', type: '专业课', departmentId: 'dept-1', majorId: 'major-3' },
  ],
  schedules: [
